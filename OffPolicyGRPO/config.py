...
class ModelPTConfig:
    ...
    num_worker_nodes: int = field(default = 3)

    rl_post_train_reward_funcs: list[str] = field(default_factory=lambda: ["accuracy"])
    rl_post_train_reward_weights: list[str] = field(default_factory=lambda: [1.0])
